...
def generate_launch_description():
    calib_cfg = _load_yaml('calibration_eye_to_hand.yaml')
    ...
    # camera_namespace='/' makes topics /front_camera/... instead of
    # /front_camera/front_camera/... . serial_no pins this launch to the
    # front camera. The leading underscore forces string parsing of the
    # serial; numeric serials with leading zeros are otherwise rejected.
    serial_arg = DeclareLaunchArgument(
        'serial_no',
        default_value='_233522077626',
        description='RealSense serial number for the front camera.',
    )
