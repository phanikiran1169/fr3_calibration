...
# fr3_calibration: Inference-PC move_group for the FR3, used by
# calibration_pose_runner to plan and execute trajectories.
#
# Adapted from franka_ros2's franka_fr3_moveit_config/launch/moveit.launch.py.
# Removes ros2_control_node, controller spawners, robot_state_publisher,
# joint_state_publisher, gripper, and rviz — those run on the RT PC via
# franka_bringup. Only move_group itself runs on the inference PC.
#
